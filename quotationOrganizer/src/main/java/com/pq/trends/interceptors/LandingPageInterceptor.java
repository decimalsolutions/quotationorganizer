package com.pq.trends.interceptors;

import static com.pq.trends.staticConstants.Constants.INTERCEPTOR_AFTERCOMPLETION;
import static com.pq.trends.staticConstants.Constants.INTERCEPTOR_POSTHANDLER;
import static com.pq.trends.staticConstants.Constants.INTERCEPTOR_PREHANDLE;
import static com.pq.trends.staticConstants.Constants.USER_KEY;
...
public class LandingPageInterceptor implements HandlerInterceptor {
	...
	public void afterCompletion(HttpServletRequest req,
			HttpServletResponse res, Object arg2, Exception exp)
			throws Exception {
...
//				WebApplicationContext context = (WebApplicationContext) req.getAttribute("org.springframework.web.servlet.DispatcherServlet.CONTEXT");
//				System.out.println((Long)context.getStartupDate()  + ""+ context.getServletContext().getServletContextName());		}
//		}
